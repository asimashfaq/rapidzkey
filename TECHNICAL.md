...
This section documents the sequence of failures and discoveries that led to the current working implementation. Each step produced a plausible hypothesis that turned out to be wrong (or only partially right), requiring deeper investigation.
